...
const articles: Article[] = [
  {
    ...
    views: 35,
    likes: 34,
    des: "در دنیای امروزی، اکثر مشاغل و کار‌ها با کامپیوتر‌ها پیوندی جدا نشدنی پیدا کرده‌اند به گونه‌ای که علوم کامپیوتری لازمه‌ای برای زنده نگه داشتن دنیای امروزی می‌باشند.",
  ...
  },
  {
    ...
    views: 42,
    likes: 3,
    des: "زبان برنامه نویسی پایتون (Python) را کم و بیش اکثر برنامه نویس ها و مهندسان جهان می شناسند و بیشتر تکنولوژی ها از جمله (Google) نیز برای اهداف خود از این زبان بهره می گیرند، یکی از پروژه های گوگل پلتفرم (Colab)، از پایتون استفاده می کند که در این مقاله ما شما را با آن آشنا خواهیم کرد.",
  ...
  },
  {
    ...
    views: 87,
    likes: 6,
    des: "همانطور که می‌دانید برنامه نویسی وب، امروزه یکی از پرکاربردترین علوم از علوم کامپیوتری هست. طراحی سمت کاربر وب، یکی از مسائلی است که امروزه ذهن بسیاری از افراد را به خودش مشغول کرده و هر روز چالش های بیشتری ایجاد می‌کند.",
  ...
  },
  {
    ...
    views: 90,
    likes: 45,
    des: "امروزه صنعت تکنولوژی روز به روز در حال پیشرفت است و شاهد آن هستیم که هر روزه ترندهای تکنولوژی در حال پیشرفت هستند. همین عامل نیز باعث می شود تا پیگیری این ترندهای تکنولوژی کمی سخت و دشوار باشد. به عنوان مثال در سال 2022 ممکن است شما ندانید که دقیقا باید کدام ترندها را پیگیری کنید.",
  ...
  },
  {
    ...
    views: 23,
    likes: 20,
    des: `ظهور API های RESTful با افزایش ابزارهایی برای ایجاد، آزمایش و مدیریت آنها همراه شده است. فرقی نمی کند که شما یک شخص مبتدی در طراحی API باشید که در حال طراحی اولین API خود هستید یا این که یک فرد متخصص در این حوزه هستید که در کوتاه ترین زمان ممکن می توانید اقدام به طراحی API کنید.`,
  ...
  },
  {
    ...
    views: 44,
    likes: 11,
    des: `این معمولا اولین سوالی است که به ذهن شما خطور می‌کند. و مغز شما احتمالا هنگام رو به رو شدن با این سوال می‌گوید "قطعا" و به دنبال این بازنگری سریع قیمت پروژه را پایین می‌آورید.`,
  ...
  },
  {
    ...
    views: 44,
    likes: 8,
    des: `TCP مخفف Transmission Control Protocol است. این یک پروتکل لایه حمل و نقل است که اجازه می‌دهد بسته‌ها از یک مکان به مکان دیگر ارسال شوند.`,
